...
data_root_train = 'data/split_ms_fair1m/'
data_root_test = 'data/split_ms_fair1m_2/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root_train + 'train/annfiles/',
        img_prefix=data_root_train + 'train/images/',
        pipeline=train_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=data_root_test + 'test/annfiles/',
